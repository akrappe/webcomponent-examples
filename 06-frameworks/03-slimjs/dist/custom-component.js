...
(function () {
  ...
  var CustomComponent = (_dec = (0, _Decorators.tag)('custom-component'), _dec2 = (0, _Decorators.template)('<div>Hello, i am a custom element</div>'), _dec(_class = _dec2(_class =
  /*#__PURE__*/
  function (_Slim) {
    _inherits(CustomComponent, _Slim);
