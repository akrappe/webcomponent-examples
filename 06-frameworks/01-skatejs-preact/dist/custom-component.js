...
/* harmony export (immutable) */ __webpack_exports__["d"] = sym;
...
function name() {
  ...
  prefix = Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* dashCase */])(prefix);
  var suffix = 0;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return withChildren; });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return withContext; });
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return withLifecycle; });
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return withUpdate; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_with_update_js__ = __webpack_require__(16);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
function defineProps(constructor) {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["c" /* keys */])(props).forEach(function (name) {
    var func = props[name];
...
function prop(definition) {
  ...
  var func = function func(_ref, name) {
    ...
    var normalised = Object(__WEBPACK_IMPORTED_MODULE_1__util_with_update_js__["a" /* normalisePropertyDefinition */])(name, propertyDefinition);
    var _value = Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["d" /* sym */])(name);
    ...
    Object.defineProperty(constructor.prototype, name, {
      ...
      set: function set(val) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__util_with_update_js__["c" /* syncPropertyToAttribute */])(this, normalised.attribute.target, normalised.serialize, val);
        this.triggerUpdate();
      }
    });
  };
  ...
  return _temp2 = _class = function (_Base) {
    ...
    _createClass(_class, [{
      ...
      value: function attributeChangedCallback(name, oldValue, newValue) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__util_with_update_js__["b" /* syncAttributeToProperty */])(this, name, newValue);
      }
    }, {
      key: 'connectedCallback',
      value: function connectedCallback() {
      ...
      get: function get() {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["c" /* keys */])(this.constructor.props).reduce(function (prev, curr) {
      ...
      set: function set(props) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["c" /* keys */])(props).forEach(function (k) {
...
var zeroOrNumber = function zeroOrNumber(val) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["b" /* empty */])(val) ? 0 : Number(val);
};
...
var array = prop({
  ...
  coerce: function coerce(val) {
    return Array.isArray(val) ? val : Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["b" /* empty */])(val) ? null : [val];
  },
...
var boolean = prop({
  ...
  deserialize: function deserialize(val) {
    return !Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["b" /* empty */])(val);
  },
...
var number = prop({
  ...
  serialize: function serialize(val) {
    return Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["b" /* empty */])(val) ? null : String(Number(val));
  }
});
...
var string = prop({
  ...
  coerce: String,
  serialize: function serialize(val) {
    return Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["b" /* empty */])(val) ? null : String(val);
  }
});
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return withRenderer; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shadow_js__ = __webpack_require__(2);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var withRenderer = function withRenderer() {
  ...
  return function (_Base) {
    ...
    _createClass(_class2, [{
      ...
      key: 'renderRoot',
      get: function get() {
        return _get(_class2.prototype.__proto__ || Object.getPrototypeOf(_class2.prototype), 'renderRoot', this) || Object(__WEBPACK_IMPORTED_MODULE_0__shadow_js__["a" /* shadow */])(this);
      }
    }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_skatejs__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__skatejs_renderer_preact__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_preact__ = __webpack_require__(8);
...
(function () {
    ...
    var CustomComponent = (function (_super) {
        ...
        Object.defineProperty(CustomComponent, "props", {
            get: function () {
                return {
                    name: __WEBPACK_IMPORTED_MODULE_1_skatejs__["a" /* props */].string,
                    url: __WEBPACK_IMPORTED_MODULE_1_skatejs__["a" /* props */].string,
                    image: __WEBPACK_IMPORTED_MODULE_1_skatejs__["a" /* props */].string
                };
            },
            enumerable: true,
            configurable: true
        });
        CustomComponent.prototype.render = function (_a) {
            var name = _a.name, url = _a.url, image = _a.image;
            console.log('render()');
            return (Object(__WEBPACK_IMPORTED_MODULE_3_preact__["a" /* h */])("div", null,
                Object(__WEBPACK_IMPORTED_MODULE_3_preact__["a" /* h */])("h2", null, name),
                Object(__WEBPACK_IMPORTED_MODULE_3_preact__["a" /* h */])("a", { href: url, target: "_blank" },
                    Object(__WEBPACK_IMPORTED_MODULE_3_preact__["a" /* h */])("img", { src: image, alt: "Image of " + name }))));
        };
        CustomComponent.prototype.connecting = function () { console.log('connecting()'); };
        CustomComponent.prototype.connected = function () { console.log('connected()'); };
        CustomComponent.prototype.rendering = function () { console.log('rendering()'); };
        CustomComponent.prototype.rendered = function () { console.log('rendered()'); };
        return CustomComponent;
    }(Object(__WEBPACK_IMPORTED_MODULE_1_skatejs__["b" /* withComponent */])(Object(__WEBPACK_IMPORTED_MODULE_2__skatejs_renderer_preact__["a" /* default */])())));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__define_js__ = __webpack_require__(12);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__emit_js__ = __webpack_require__(13);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__link_js__ = __webpack_require__(14);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__name_js__ = __webpack_require__(1);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shadow_js__ = __webpack_require__(2);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__with_children_js__ = __webpack_require__(3);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__with_context_js__ = __webpack_require__(4);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__with_component_js__ = __webpack_require__(15);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_7__with_component_js__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__with_lifecycle_js__ = __webpack_require__(5);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__with_update_js__ = __webpack_require__(6);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_9__with_update_js__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__with_renderer_js__ = __webpack_require__(7);
/* unused harmony namespace reexport */
...
function define(Ctor) {
  customElements.define(Ctor.is || Object(__WEBPACK_IMPORTED_MODULE_0__name__["a" /* name */])(), Ctor);
  return Ctor;
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__with_children_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__with_context_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__with_lifecycle_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__with_update_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__with_renderer_js__ = __webpack_require__(7);
...
var withComponent = function withComponent() {
  var Base = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : HTMLElement;
  return Object(__WEBPACK_IMPORTED_MODULE_2__with_lifecycle_js__["a" /* withLifecycle */])(Object(__WEBPACK_IMPORTED_MODULE_0__with_children_js__["a" /* withChildren */])(Object(__WEBPACK_IMPORTED_MODULE_1__with_context_js__["a" /* withContext */])(Object(__WEBPACK_IMPORTED_MODULE_3__with_update_js__["b" /* withUpdate */])(Object(__WEBPACK_IMPORTED_MODULE_4__with_renderer_js__["a" /* withRenderer */])(Base || HTMLElement)))));
};
...
/* harmony export (immutable) */ __webpack_exports__["b"] = syncAttributeToProperty;
/* harmony export (immutable) */ __webpack_exports__["c"] = syncPropertyToAttribute;
...
function normaliseAttributeDefinition(name, prop) {
  ...
  if (obj.source === true) {
    obj.source = Object(__WEBPACK_IMPORTED_MODULE_0__index_js__["a" /* dashCase */])(name);
  }
  if (obj.target === true) {
    obj.target = Object(__WEBPACK_IMPORTED_MODULE_0__index_js__["a" /* dashCase */])(name);
  }
  return obj;
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(8);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
  ...
  return function (_Base) {
    ...
    _createClass(_class, [{
      ...
      value: function renderer(root, call) {
        this._preactDom = Object(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* render */])(call(), root, this._preactDom || root.children[0]);
      }
    }, {
      key: 'props',
      get: function get() {
        ...
        return _extends({}, _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'props', this), { children: Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])('slot', null) });
      }
    }]);
