...
function setup(content) {
  const children = new __WEBPACK_IMPORTED_MODULE_1__shared_poorlyfills_js__["c" /* WeakMap */];
  ...
  const get = (Class, info, id) => {
    switch (typeof id) {
      case 'object':
      case 'function':
        const wm = info.w || (info.w = new __WEBPACK_IMPORTED_MODULE_1__shared_poorlyfills_js__["c" /* WeakMap */]);
...
(function () {
  ...
  function (_HTMLElement) {
    ...
    function CustomComponent() {
      ...
      _this.html = _esm.hyper.bind(_assertThisInitialized(_this));
      return _this;
    }
    ...
    _createClass(CustomComponent, [{
      ...
      value: function connectedCallback() {
        ...
        document.addEventListener('state', function (e) {
          _this2.counter = e.detail.counter;
  ...
  }(_wrapNativeSuper(HTMLElement)); // CustomComponent.define('custom-component');
