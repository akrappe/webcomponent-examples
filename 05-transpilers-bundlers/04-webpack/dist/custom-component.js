  ...
  function (_HTMLElement) {
    ...
    _createClass(CustomComponent, [{
      ...
      value: function createTemplate() {
        ...
        var image = 'https://cdn.macrumors.com/article-new/2017/10/steve-jobs-800x533.jpg'; // simple es6 template literal for the sake of simplicity

        return "\n                <h2>".concat(name, "</h2>\n                <a href=\"").concat(url, "\" target=\"_blank\">\n                    <img src=\"").concat(image, "\" alt=\"Image of ").concat(name, "\">\n                </a>\n            ");
      }
    }]);
